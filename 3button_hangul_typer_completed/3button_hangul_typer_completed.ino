...
///////////////////////////변수변경/////////////////////////
  while(1)
  {
    ...
    else if((consonant==0)&&(vowel==14)&&(bottomConsonant==0))//과
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B01110100;
      upperchar[1] = B00010100;
      upperchar[2] = B00100110;
      upperchar[3] = B01111100;
      upperchar[4] = B00000100;
    ...
    else if((consonant==2)&&(vowel==14)&&(bottomConsonant==0))//놔
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B01000100;
      upperchar[1] = B01000100;
      upperchar[2] = B01110100;
      upperchar[3] = B00100110;
      upperchar[4] = B01111100;
      upperchar[5] = B00000100;
      upperchar[6] = B00000000;
      upperchar[7] = B00000000;
      for(int j=0; j<8; j++)
      {
    ...
    else if((consonant==7)&&(vowel==14)&&(bottomConsonant==0))//봐
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B01010100;
      upperchar[1] = B01110100;
      upperchar[2] = B01010100;
      upperchar[3] = B01110100;
      upperchar[4] = B00100110;
      upperchar[5] = B01111100;
      upperchar[6] = B00000100;
      upperchar[7] = B00000000;
      for(int j=0; j<8; j++)
      {
        lc.setRow(Mposition, j, upperchar[j]); //Mposition번째 매트릭스에서 받침없는 글자를 출력
    ...
    else if((consonant==11)&&(vowel==14)&&(bottomConsonant==0))//와
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B01100100;
      upperchar[1] = B10010100;
    ...
    else if((consonant==12)&&(vowel==14)&&(bottomConsonant==0))//좌
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B00000100;
      upperchar[1] = B01110100;
      upperchar[2] = B00100100;
      upperchar[3] = B01010100;
      upperchar[4] = B00100110;
      upperchar[5] = B11111100;
      upperchar[6] = B00000100;
      upperchar[7] = B00000000;
      for(int j=0; j<8; j++)
      {
    ...
    else if((consonant==18)&&(vowel==14)&&(bottomConsonant==0))//화
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B00100100;
      upperchar[1] = B01110100;
      upperchar[2] = B00000100;
      upperchar[3] = B00100100;
      upperchar[4] = B00000110;
      upperchar[5] = B00100100;
      upperchar[6] = B01111100;
      upperchar[7] = B00000100;
      for(int j=0; j<8; j++)
      {
        lc.setRow(Mposition, j, upperchar[j]); //Mposition번째 매트릭스에서 받침없는 글자를 출력
      }
    }
    else if((consonant==11)&&(vowel==15)&&(bottomConsonant==0))//왜
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B01100101;
      upperchar[1] = B10010101;
      upperchar[2] = B10010101;
      upperchar[3] = B01100101;
      upperchar[4] = B00100111;
      upperchar[5] = B01111101;
      upperchar[6] = B00000101;
      upperchar[7] = B00000000;
      for(int j=0; j<8; j++)
      {
        lc.setRow(Mposition, j, upperchar[j]); //Mposition번째 매트릭스에서 받침없는 글자를 출력
    ...
    else if((consonant==11)&&(vowel==13)&&(bottomConsonant==0))//예
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B00000000;
      upperchar[1] = B01100101;
      upperchar[2] = B10011101;
      upperchar[3] = B10010101;
      upperchar[4] = B01101101;
      upperchar[5] = B00000101;
      upperchar[6] = B00000101;
      upperchar[7] = B00000000;
      for(int j=0; j<8; j++)
      {
    ...
    else if((consonant==18)&&(vowel==20)&&(bottomConsonant==0))//희
    {
      //예외적으로 출력하고 싶은 글자들은 여기에 직접 추가로 도트작업하기
      upperchar[0] = B00100100;
      upperchar[1] = B01110100;
    ...
    else
    {
      ...
      switch((consonant==4)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B11000101;
          upperchar[1] = B01001101;
          upperchar[2] = B10000101;
          upperchar[3] = B11000101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==6)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==7)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B10100101;
          upperchar[1] = B11101101;
          upperchar[2] = B10100101;
          upperchar[3] = B11100101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==8)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B11010101;
          upperchar[1] = B11111101;
          upperchar[2] = B11010101;
          upperchar[3] = B11110101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==9)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==10)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B01010011;
          upperchar[1] = B10101011;
          upperchar[2] = B00000111;
          upperchar[3] = B00000011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==11)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B01100101;
          upperchar[1] = B10011101;
          upperchar[2] = B10010101;
          upperchar[3] = B01100101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==12)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==13)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B11111011;
          upperchar[1] = B01010111;
          upperchar[2] = B10101011;
          upperchar[3] = B00000011;
          upperchar[4] = B00000000;
      ...
      switch((consonant==16)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==17)&&(vowel==12))
      {
        case 1:
          upperchar[0] = B11110101;
          upperchar[1] = B01101101;
          upperchar[2] = B11110101;
          upperchar[3] = B00000101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==18)&&(vowel==12))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==0)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11100010;
          upperchar[1] = B00100010;
          upperchar[2] = B00101011;
          upperchar[3] = B00011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==1)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11110010;
          upperchar[1] = B01010010;
          upperchar[2] = B00001011;
          upperchar[3] = B00011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==2)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B10000010;
          upperchar[1] = B10000010;
          upperchar[2] = B11101011;
          upperchar[3] = B00011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
      ...
      switch((consonant==4)&&(vowel==14))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11000010;
          upperchar[1] = B01000010;
          upperchar[2] = B10001011;
          upperchar[3] = B11011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==7)&&(vowel==14))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==8)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11010010;
          upperchar[1] = B11110010;
          upperchar[2] = B11011011;
          upperchar[3] = B11111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==9)&&(vowel==14))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==10)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B01010010;
          upperchar[1] = B10101010;
          upperchar[2] = B00010011;
          upperchar[3] = B00111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==11)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B01000010;
          upperchar[1] = B10100010;
          upperchar[2] = B01001011;
          upperchar[3] = B00011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
      ...
      switch((consonant==13)&&(vowel==14))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==14)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B01000010;
          upperchar[1] = B11100010;
          upperchar[2] = B01001011;
          upperchar[3] = B10111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==15)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11000010;
          upperchar[1] = B01000010;
          upperchar[2] = B11001011;
          upperchar[3] = B01011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==16)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11000010;
          upperchar[1] = B11000010;
          upperchar[2] = B10001011;
          upperchar[3] = B11011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==17)&&(vowel==14))
      {
        case 1:
          upperchar[0] = B11110010;
          upperchar[1] = B01100010;
          upperchar[2] = B11101011;
          upperchar[3] = B00011110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==18)&&(vowel==14))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==0)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11100001;
          upperchar[1] = B00100101;
          upperchar[2] = B00101111;
          upperchar[3] = B00000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==1)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11110001;
          upperchar[1] = B01010101;
          upperchar[2] = B00001111;
          upperchar[3] = B00000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==2)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B10000001;
          upperchar[1] = B10000101;
          upperchar[2] = B11101111;
          upperchar[3] = B00000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==3)&&(vowel==16))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==4)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11110001;
          upperchar[1] = B10100001;
          upperchar[2] = B11110101;
          upperchar[3] = B00001111;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11000001;
          upperchar[1] = B01000101;
          upperchar[2] = B10001111;
          upperchar[3] = B11000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==6)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11100001;
          upperchar[1] = B10100101;
          upperchar[2] = B11101111;
          upperchar[3] = B00000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==7)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B10100001;
          upperchar[1] = B11100101;
          upperchar[2] = B10101111;
          upperchar[3] = B11100001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==8)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11010001;
          upperchar[1] = B11110101;
          upperchar[2] = B11011111;
          upperchar[3] = B11110001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==9)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B10100101;
          upperchar[2] = B10101111;
          upperchar[3] = B00000001;
          upperchar[4] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==10)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B01010010;
          upperchar[1] = B10101010;
          upperchar[2] = B00010010;
          upperchar[3] = B00111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==11)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B01100001;
          upperchar[1] = B10010001;
          upperchar[2] = B10010101;
          upperchar[3] = B01101111;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==13)&&(vowel==16))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==14)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B11100101;
          upperchar[2] = B01001111;
          upperchar[3] = B10100001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==15)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11100001;
          upperchar[1] = B00100101;
          upperchar[2] = B11101111;
          upperchar[3] = B00100001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==16)&&(vowel==16))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==17)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B11110001;
          upperchar[1] = B01100001;
          upperchar[2] = B11110101;
          upperchar[3] = B00001111;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==18)&&(vowel==16))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B11100101;
          upperchar[2] = B00001111;
          upperchar[3] = B01000001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==0)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11000001;
          upperchar[1] = B01011111;
          upperchar[2] = B00001001;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==1)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11110001;
          upperchar[1] = B01010001;
          upperchar[2] = B00011111;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==2)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B10000001;
          upperchar[1] = B11011111;
          upperchar[2] = B00001001;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==3)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11100001;
          upperchar[1] = B10011111;
          upperchar[2] = B11101001;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
      ...
      switch((consonant==4)&&(vowel==17))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11000001;
          upperchar[1] = B01011111;
          upperchar[2] = B10001001;
          upperchar[3] = B11001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==6)&&(vowel==17))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==7)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B10100001;
          upperchar[1] = B11111111;
          upperchar[2] = B10101001;
          upperchar[3] = B11101011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==8)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11010001;
          upperchar[1] = B11110001;
          upperchar[2] = B11011111;
          upperchar[3] = B11111011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==9)&&(vowel==17))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==10)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B01010001;
          upperchar[1] = B10101001;
          upperchar[2] = B00011111;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==11)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B10100001;
          upperchar[2] = B01011111;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
      ...
      switch((consonant==12)&&(vowel==17))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==13)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11111001;
          upperchar[1] = B01010001;
          upperchar[2] = B10111111;
          upperchar[3] = B00001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==14)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B11111111;
          upperchar[2] = B01001001;
          upperchar[3] = B10101011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==15)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B11000001;
          upperchar[1] = B01011111;
          upperchar[2] = B11001001;
          upperchar[3] = B01001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
      ...
      switch((consonant==17)&&(vowel==17))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==18)&&(vowel==17))
      {
        case 1:
          upperchar[0] = B01000001;
          upperchar[1] = B11100001;
          upperchar[2] = B00011111;
          upperchar[3] = B01001011;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==0)&&(vowel==19))
      {
        case 1:
          upperchar[0] = B00111010;
          upperchar[1] = B00001010;
          upperchar[2] = B00111110;
          upperchar[3] = B00010010;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==1)&&(vowel==19))
      {
        case 1:
          upperchar[0] = B01111010;
          upperchar[1] = B00101010;
          upperchar[2] = B01111110;
          upperchar[3] = B00010010;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==2)&&(vowel==19))
      {
        case 1:
          upperchar[0] = B10000001;
          upperchar[1] = B10000001;
          upperchar[2] = B11101111;
          upperchar[3] = B00000101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==4)&&(vowel==19))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==19))
      {
        case 1:
          upperchar[0] = B11000001;
          upperchar[1] = B01000001;
          upperchar[2] = B10001111;
          upperchar[3] = B11000101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==14)&&(vowel==19))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==15)&&(vowel==19))
      {
        case 1:
          upperchar[0] = B11100001;
          upperchar[1] = B00100001;
          upperchar[2] = B11101111;
          upperchar[3] = B00100101;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==1)&&(vowel==20))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==2)&&(vowel==20))
      {
        case 1:
          upperchar[0] = B00100010;
          upperchar[1] = B00111010;
          upperchar[2] = B00000010;
          upperchar[3] = B00111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
      ...
      switch((consonant==3)&&(vowel==20))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==4)&&(vowel==20))
      {
        case 1:
          upperchar[0] = B01111010;
          upperchar[1] = B01010010;
          upperchar[2] = B01111010;
          upperchar[3] = B00111110;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==5)&&(vowel==20))
      {
        case 1:
          upperchar[0] = B11000010;
          upperchar[1] = B01000010;
          upperchar[2] = B10011110;
          upperchar[3] = B11000010;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
      ...
      switch((consonant==9)&&(vowel==20))
      {
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==10)&&(vowel==20))
      {
        case 1:
          upperchar[0] = B01010001;
          upperchar[1] = B10101001;
          upperchar[2] = B00000001;
          upperchar[3] = B00011111;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      switch((consonant==11)&&(vowel==20))
      {
        case 1:
          upperchar[0] = B01100001;
          upperchar[1] = B10010001;
          upperchar[2] = B10010111;
          upperchar[3] = B01100001;
          upperchar[4] = B00000000;
          upperchar[5] = B00000000;
          upperchar[6] = B00000000;
          upperchar[7] = B00000000;
